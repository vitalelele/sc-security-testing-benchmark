...
CATEGORY="arithmetic_errors"
TIMEBOX=600
RUNS=5

# contratti della categoria
CONTRACTS=(
  "arithmetic_errors/integer_overflow_1.sol"
  "arithmetic_errors/integer_overflow_mul.sol"
  "arithmetic_errors/overflow_single_tx.sol"
)
...
echo "All arithmetic runs completed."
